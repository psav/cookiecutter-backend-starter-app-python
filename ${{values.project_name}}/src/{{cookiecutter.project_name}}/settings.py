"""
Django settings for ${{values.project_name}} project.
...
APP_NAME = os.getenv("APP_NAME", "${{values.project_name}}")
...
MIDDLEWARE = [
    '${{values.project_name}}.middleware.healthcheckmiddleware.HealthCheckMiddleware',
    ...
    '${{values.project_name}}.middleware.metricsmiddleware.MetricsMiddleware',
]

ROOT_URLCONF = '${{values.project_name}}.urls'
...
WSGI_APPLICATION = '${{values.project_name}}.wsgi.application'
